...
public class CajaHistorica extends Identifiable implements Job {
    ...
    public BigDecimal getCalculaBalance() {
        return getCalculaTotalEntrada().subtract(getCalculaTotalSalida());
    }
 ...
 /*   @PrePersist
    ...
    private void calcularPropiedadesPersistentes() {
        this.totalEntrada = getCalculaTotalEntrada();
        this.totalSalida = getCalculaTotalSalida();
        this.balance = getCalculaBalance();
        this.totalGeneral = getCalculaTotalGeneral();
        this.historicoDeCaja = getHistoricoDeCajaCalculado();
    }*/
    ...
    public void execute(JobExecutionContext context) {
        ...
        try {
            ...
            BigDecimal balance = cajaTemporal.getBalance();
           

            // Log para depuración
            System.out.println("Total balance calculado: " + balance);
          

            // Validar si totalEntrada o totalSalida son BigDecimal.ZERO o null
