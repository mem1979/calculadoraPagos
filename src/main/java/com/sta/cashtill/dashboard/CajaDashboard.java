...
public class CajaDashboard {
    ...
    public Collection<Caja> getCajaOrdenada() {
        Query query = XPersistence.getManager()
            .createQuery("FROM Caja c WHERE c.cantidad > 0 ORDER BY c.denominacion.valor DESC");
    ...
    public Collection<DistribucionPorTipoMovimiento> getDistribucionPorTipoMovimiento() {
        ...
        String jpql = "SELECT new com.sta.cashtill.dashboard.DistribucionPorTipoMovimiento(c.tipoMovimiento, SUM(ABS(c.total))) " +
