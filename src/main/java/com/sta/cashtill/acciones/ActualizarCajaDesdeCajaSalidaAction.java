...
public class ActualizarCajaDesdeCajaSalidaAction extends SaveAction {
    ...
    public void execute() throws Exception {
        ...
        if (getErrors().isEmpty()) {
            ...
            if (getErrors().isEmpty()) {
            	if (cajaSalida.getMovimientoCaja().getNombre().equalsIgnoreCase("VUELTO")) {
            		getPreviousView().setValueNotifying("conVuelto", true);
                	closeDialog();
            	  	addMessage("Salida de Caja por Vuelto registrada correctamente.");
            		...
            		closeDialog();
            		addMessage("SALIDA de Caja actualizada correctamente.");		
            		}
            } else {
