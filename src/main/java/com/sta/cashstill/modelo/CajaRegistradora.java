...
abstract public class CajaRegistradora extends Identifiable {
   ...
   // @Hidden // No se mostrará por defecto en las vistas y los tabs
	...
	private Collection <DetalleCajaRegistradora> detalle ;//= new ArrayList<>();
    ...
    private void Actualizar() {
	   	...
	   	setDescripcion(getGenerarDescripcion(getObtenerNombreUsuario(), getMovimientoCajaCategoria(), fechaHora));
...
// Obtiene la Categoria de movimientoCaja
   ...
   public String getGenerarDescripcion(String usuario, String tipoMovimiento, Date fecha) {
