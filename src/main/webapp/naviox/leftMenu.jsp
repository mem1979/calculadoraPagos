...
List<String> modulosOcultos = Arrays.asList("cajadepagos/Denominaciones");
            ...
            <tr id="modules_list_content">
                <td>
                    ...
                    for (Object moduleObj : listaModulos) {
                        ...
                        if (!modulosOcultos.contains(moduleName.replace("MetaModule: ", ""))) { %>
                            <li>
                                <a href="<%= request.getContextPath() %>/m/<%= moduleName.replace("MetaModule: ", "") %>">
                                    <%= moduleName.replace("MetaModule: ", "") %>
                                </a>
                            </li>
                        <% }
                    }
